	...
	return (
		<div name="home" className="w-full h-screen bg-[#0a192f] main-div">
			...
			<div className="max-w-[1000px] mx-auto px-8 h-full flex flex-col justify-center text-gray-400">
				...
				<p className="text-[#8892a0] py-4 max-w-[700px]">
				...
				<div className="marquee-container">
					<div className="marquee-content">
						<p className="font-2xl">
							Site is under construction, Projects and their corresponding codes
							are yet to be uploaded. To provide any feedback feel free to use
							the contact form{' '}
						</p>
					</div>
				</div>
